...
<head runat="server">
    ...
    <script type="text/javascript" src="js/OLD_JS/accommodation-searchbox.js"></script>
    <script type="text/javascript" src="js/OLD_JS/FlightSearch_Mix.js"></script>
    <script type="text/javascript" src="js/OLD_JS/validation_en.js"></script>
    ...
    <script type="text/javascript" src="js/ctc.fe.validate.js"></script>
    ...
    <form id="form1">
        ...
        <div class='globalContainer' style="background: url(img/pic-header.jpg) no-repeat;">
            ...
            <script type="text/javascript">
                ...
                $('#forgotPwd_btn').live('click', function () {
                    if (validate_submit('.forgotPwd', 'NO_SCROLL', 'AJAX_POST')) {

                        $.post('ajax-script.html', { update_type: 'MEMBER_FORGOT_PASSWORD', email: $('#forgotPwd_email').val() }, function (data) {
                            $('#dlgBox').dialog({
                                width: 350,
                                height: 150,
                                resizable: false,
                ...
                $('#retrieveLogin_btn').live('click', function () {
                    if (validate_submit('.retrieveLoginWrapper', 'NO_SCROLL', 'AJAX_POST')) {

                        //$.post('ajax-script.php', {update_type:'MEMBER_RETRIEVE_LOGIN', nric: $('#retrieveLogin_nric').val(), fullname:$('#retrieveLogin_fullname').val(), dob:$('#retrieveLogin_dob').val() }, function(data){
                        $.post('ajax-script.html', { update_type: 'MEMBER_RETRIEVE_LOGIN', nric: $('#retrieveLogin_nric').val(), fullname: $('#retrieveLogin_fullname').val() }, function (data) {
                            $('#dlgBox').dialog({
                                width: 350,
                                height: 220,
                                resizable: false,
                                    ...
                                    <form name='homeSearchGrouptour' id='homeSearchGrouptour' method='post' action='http://www.ctc.com.sg/group-tour-search.php'>
                                        <table cellspacing='0' cellpadding='0' style='width: 100%' class='formTable'>
                                            <tr>
                                                ...
                                                <script type='text/javascript'>
                                                    $(document).ready(function () {
                                                        $('#group_tour_search').click(function () {
                                                            $('#homeSearchGrouptour').attr('action', 'group-tour-search.html');
                                                        })
                                                        $('#fit_search').click(function () {
                                                            $('#homeSearchGrouptour').attr('action', 'fit-tour-search.html');
                                                        })
                                                    });
								</script>
                                            </tr>
                        ...
                        <table cellspacing='8' class='formTable2'>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:Label runat="server" ID="Label1">No Weather</asp:Label>
                                      
                                </td>
                                <td class='label'>Destination : </td>
                                <td>
                                    <select name='destination' id='destination' class='selectBox' style='width: 220px'>
                                        <option value=''>- All Destinations -</option>
                                    </select></td>
                            </tr>
                            <tr>
